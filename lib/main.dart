            ...
            Row(
              ...
              children: [
                ...
                Card(
                  ...
                  child: InkWell(
                      onTap: () async {
                        if (!await launchUrl(Uri.parse(IG + la_forlivese_ig),
                            mode: LaunchMode.externalApplication)) {
                      ...
                      child: const SizedBox(
                        ...
                        child: AspectRatio(
                          aspectRatio: 16 / 9,
                          child: Image(
                            image: AssetImage('assets/images/la_forlivese.png'),
                            fit: BoxFit.cover,
                          ),
                        ),
                      )),
                ...
                Card(
                  ...
                  child: InkWell(
                      onTap: () async {
                        if (!await launchUrl(Uri.parse(IG + comune_di_cesena),
                            mode: LaunchMode.externalApplication)) {
                      ...
                      child: const SizedBox(
                        ...
                        child: AspectRatio(
                          ...
                          child: Image(
                            image:
                                AssetImage('assets/images/comune_cesena.png'),
                            fit: BoxFit.contain,
                          ),
                        ),
                      )),
